...
def state_count(iterations_of_circuit, error, rotation_iterations = 5):
    state_count_0 = 0
    state_count_1 = 1
...
def state_probability(iterations_of_circuit, error, rotation_iterations = 5):
    state_count_0 = state_count(iterations_of_circuit, error, rotation_iterations)
